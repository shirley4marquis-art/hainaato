...
const LABELS = {
  en: {
    ...
    cbTotal: "CIF total",
    cifBreakdownNote:
      "FOB plus the shipping items above equal the CIF price. Shipping amounts are near-market approximations for planning and customs declaration; the CIF total payable to HAINA AUTO EXPORT is fixed.",
  ...
  es: {
    ...
    cbTotal: "Total CIF",
    cifBreakdownNote:
      "El FOB más los conceptos de embarque anteriores equivalen al precio CIF. Los montos de embarque son aproximaciones cercanas al mercado, para planificación y declaración aduanera; el total CIF pagadero a HAINA AUTO EXPORT es fijo.",
    destinationChargesExcluded:
