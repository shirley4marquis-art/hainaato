...
const LABELS = {
  en: {
    ...
    total: "TOTAL",
    payable: "TOTAL PAYABLE TO NINDGE AUTOMOBILE",
    ...
    cifBreakdownHeading: "CIF price breakdown",
    cbGoods: "Vehicle / goods value (FOB)",
    cbExportClearance: "Export & customs clearance (China)",
    cbOriginHandling: "Origin port & terminal handling",
    cbOceanFreight: "Ocean freight to destination port",
    cbInsurance: "Marine cargo insurance (110% CIF cover)",
    cbDocumentation: "Export documentation & shipping fees",
    cbBillOfLading: "Bill of Lading (B/L) issuance",
    cbTotal: "CIF total",
    cifBreakdownNote:
      "FOB plus the shipping items above equal the CIF price. Shipping amounts are near-market approximations for planning and customs declaration; the CIF total payable to NINDGE AUTOMOBILE is fixed.",
    ...
    destinationEstimateNote: "Estimate only — not an amount payable to NINDGE AUTOMOBILE. Confirm exact figures with your local customs broker.",
    ...
    customsBreakdownCif: "CIF",
    customsBreakdownDuty: "Duty",
    customsBreakdownServiceFee: "Service fee",
    customsBreakdownVat: "VAT",
    customsBreakdownLuxury: "Luxury surcharge",
    ...
    signCompany: "For and on behalf of NINDGE AUTOMOBILE",
  ...
  es: {
    ...
    total: "TOTAL",
    payable: "TOTAL PAGADERO A NINDGE AUTOMOBILE",
    ...
    cifBreakdownHeading: "Desglose del precio CIF",
    cbGoods: "Valor del vehículo / mercancía (FOB)",
    cbExportClearance: "Despacho de exportación y aduana (China)",
    cbOriginHandling: "Manejo en puerto y terminal de origen",
    cbOceanFreight: "Flete marítimo al puerto de destino",
    cbInsurance: "Seguro marítimo de carga (cobertura 110% CIF)",
    cbDocumentation: "Documentación de exportación y gastos de embarque",
    cbBillOfLading: "Emisión del conocimiento de embarque (B/L)",
    cbTotal: "Total CIF",
    cifBreakdownNote:
      "El FOB más los conceptos de embarque anteriores equivalen al precio CIF. Los montos de embarque son aproximaciones cercanas al mercado, para planificación y declaración aduanera; el total CIF pagadero a NINDGE AUTOMOBILE es fijo.",
    destinationChargesExcluded:
    ...
    destinationEstimateNote: "Solo un estimado — no es un monto pagadero a NINDGE AUTOMOBILE. Confirme las cifras exactas con su agente aduanal local.",
    ...
    customsBreakdownCif: "CIF",
    customsBreakdownDuty: "Arancel",
    customsBreakdownServiceFee: "Servicio aduanero",
    customsBreakdownVat: "IVA",
    customsBreakdownLuxury: "Tasa de lujo",
    ...
    signCompany: "Por y en nombre de NINDGE AUTOMOBILE",
