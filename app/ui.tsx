...
import {BadgeCheck,Building2,CarFront,ChevronDown,House,Menu,Newspaper,Ship,ShoppingCart,Sparkles,X,type LucideIcon} from "lucide-react";
...
export function SiteShell({children}:{children:ReactNode}) {
  ...
  return <>
    ...
    <header className="ah-header"><div className="container">
      <div className="mobile-header-minimal"><div className="mobile-header-brand"><Link href="/" aria-label="Nindge Automobile home"><img src="/images/KkwGH.png" alt=""/><span>NINDGE<small>AUTOMOBILE</small></span></Link></div><VehicleSearch mobile/><Link className="ah-cart-link" href="/cart" aria-label={`Cart, ${cartCount} vehicle${cartCount===1?"":"s"}`}><ShoppingCart/>{cartCount>0&&<span className="ah-cart-badge">{cartCount}</span>}</Link><Link className="mobile-header-quote" href="/quote">Get Quote</Link></div>
