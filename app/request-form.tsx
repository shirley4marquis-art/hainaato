...
export function RequestForm({kind}:{kind:"quote"|"contact"|"dealer"}){
  ...
  async function submit(event:FormEvent<HTMLFormElement>){
    ...
    const result=await submitLead({name:field(data,"name"),email:field(data,"email"),phone:field(data,"phone"),company:field(data,"company"),message:field(data,"message"),source:`request-form:${kind}`});
